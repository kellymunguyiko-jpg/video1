...
// Validate ../../../src/app/api/channel-zip/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/channel-zip">> = Specific
  const handler = {} as typeof import("../../../src/app/api/channel-zip/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../../src/app/api/channel/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/channel">> = Specific
  const handler = {} as typeof import("../../../src/app/api/channel/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
